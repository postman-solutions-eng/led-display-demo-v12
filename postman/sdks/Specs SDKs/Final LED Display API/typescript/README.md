# FinalLedDisplayApiSdk TypeScript SDK 1.0.0
...
```bash
npm install final-led-display-api-sdk
```

or

```bash
yarn add final-led-display-api-sdk
```
...
```ts
const finalLedDisplayApiSdk = new FinalLedDisplayApiSdk({ timeout: 10000 });
```
