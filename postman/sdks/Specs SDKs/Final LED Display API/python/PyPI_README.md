# FinalLedDisplayApiSdk Python SDK 1.0.0<a id="finalleddisplayapisdk-python-sdk-100"></a>
...
# API for controlling LED name badge displays<a id="api-for-controlling-led-name-badge-displays"></a>
...
## Supported Icons<a id="supported-icons"></a>
...
## Character Restrictions<a id="character-restrictions"></a>
...
## Additional Capabilities (not exposed in API yet)<a id="additional-capabilities-not-exposed-in-api-yet"></a>
...
## How the spec was created<a id="how-the-spec-was-created"></a>
